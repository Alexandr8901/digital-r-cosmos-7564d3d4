  ...
  head: () => ({
    meta: [
      ...
      { title: "ЦифроРубль — Единая финансовая экосистема России" },
      {
        name: "description",
        content:
          "Единая платформа цифрового рубля России. Один аккаунт для граждан, самозанятых, бизнеса и разработчиков.",
      },
      { name: "theme-color", content: "#0f1838" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "ЦифроРубль" },
