...
export const Route = createFileRoute("/_authenticated/business/integrations")({
...
function Page() {
  return (
    <PlatformPage
      title="Интеграции"
      description="Подключённые сервисы и коннекторы"
      action={
        <>
    ...
    >
      <FeatureGrid items={[
          ...
          { icon: Sparkles, title: "Бухгалтерия", description: "1C, Контур, СБИС" },
          { icon: Sparkles, title: "Маркетплейсы", description: "OZON, WB" },
          { icon: Sparkles, title: "Доставка", description: "СДЭК, Яндекс" }
        ]} />
    </PlatformPage>
  );
}
