...
export const Route = createFileRoute("/_authenticated/developers/sandbox")({
  head: () => ({ meta: [{ title: "Sandbox · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    ...
    >
      <FeatureGrid items={[
          { icon: Sparkles, title: "Тестовые пользователи", description: "Сгенерировать" },
          { icon: Sparkles, title: "Тестовые организации", description: "Сгенерировать" },
          { icon: Sparkles, title: "Тестовые платежи", description: "Безопасные сценарии" },
          { icon: Sparkles, title: "Очистить данные", description: "Полный сброс" }
        ]} />
    </PlatformPage>
  );
}
