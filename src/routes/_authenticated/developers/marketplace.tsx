...
export const Route = createFileRoute("/_authenticated/developers/marketplace")({
  head: () => ({ meta: [{ title: "Marketplace для разработчиков · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Marketplace для разработчиков"
      description="Расширения и шаблоны"
      action={
        <>
