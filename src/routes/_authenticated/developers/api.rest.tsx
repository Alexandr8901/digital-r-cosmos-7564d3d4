...
export const Route = createFileRoute("/_authenticated/developers/api/rest")({
  head: () => ({ meta: [{ title: "REST API · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="REST API"
      description="Описание REST-методов и эндпоинтов"
      action={
        <>
