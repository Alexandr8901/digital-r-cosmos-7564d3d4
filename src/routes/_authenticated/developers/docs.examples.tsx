...
export const Route = createFileRoute("/_authenticated/developers/docs/examples")({
  head: () => ({ meta: [{ title: "Примеры кода · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Примеры кода"
      description="Готовые сниппеты на 12+ языках"
      action={
        <>
