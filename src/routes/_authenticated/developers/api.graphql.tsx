...
export const Route = createFileRoute("/_authenticated/developers/api/graphql")({
  head: () => ({ meta: [{ title: "GraphQL · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="GraphQL"
      description="Schema, queries, mutations, subscriptions"
      action={
        <>
