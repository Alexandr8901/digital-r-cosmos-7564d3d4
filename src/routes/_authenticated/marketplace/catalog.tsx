...
export const Route = createFileRoute("/_authenticated/marketplace/catalog")({
  head: () => ({ meta: [{ title: "Каталог приложений · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      ...
      description="Все приложения и расширения"
      action={
        <>
