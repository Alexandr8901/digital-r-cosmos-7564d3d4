...
export const Route = createFileRoute("/_authenticated/marketplace/official")({
  head: () => ({ meta: [{ title: "Официальные интеграции · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Официальные интеграции"
      description="Проверенные подключения"
      action={
        <>
