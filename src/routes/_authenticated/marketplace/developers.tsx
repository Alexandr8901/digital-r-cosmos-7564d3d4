...
export const Route = createFileRoute("/_authenticated/marketplace/developers")({
  head: () => ({ meta: [{ title: "Разработчики · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Разработчики"
      description="Топ разработчиков и команды"
      action={
        <>
