...
export const Route = createFileRoute("/_authenticated/marketplace/settings")({
  head: () => ({ meta: [{ title: "Настройки Marketplace · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Настройки Marketplace"
      description="Уведомления и регион"
      action={
        <>
