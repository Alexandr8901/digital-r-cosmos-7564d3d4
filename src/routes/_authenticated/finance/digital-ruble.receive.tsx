...
export const Route = createFileRoute("/_authenticated/finance/digital-ruble/receive")({
  head: () => ({ meta: [{ title: "Получение ЦР · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Получение ЦР"
      description="Создание ссылок и QR"
      action={
        <>
