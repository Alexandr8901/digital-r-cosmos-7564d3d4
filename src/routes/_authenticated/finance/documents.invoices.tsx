...
export const Route = createFileRoute("/_authenticated/finance/documents/invoices")({
  head: () => ({ meta: [{ title: "Счета · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Счета"
      description="Выставленные и полученные счета"
      action={
        <>
