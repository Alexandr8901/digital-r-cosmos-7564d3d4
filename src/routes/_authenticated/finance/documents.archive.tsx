...
export const Route = createFileRoute("/_authenticated/finance/documents/archive")({
  head: () => ({ meta: [{ title: "Архив документов · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      ...
      description="Завершённые документы"
      action={
        <>
