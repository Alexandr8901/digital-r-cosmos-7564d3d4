...
export const Route = createFileRoute("/_authenticated/finance/digital-ruble/history")({
  head: () => ({ meta: [{ title: "История ЦР · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="История ЦР"
      description="Операции с цифровым рублём"
      action={
        <>
