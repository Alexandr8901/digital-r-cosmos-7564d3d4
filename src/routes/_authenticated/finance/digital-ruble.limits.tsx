...
export const Route = createFileRoute("/_authenticated/finance/digital-ruble/limits")({
  head: () => ({ meta: [{ title: "Лимиты ЦР · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Лимиты ЦР"
      description="Дневные и месячные лимиты"
      action={
        <>
