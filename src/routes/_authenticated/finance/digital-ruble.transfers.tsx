...
export const Route = createFileRoute("/_authenticated/finance/digital-ruble/transfers")({
  head: () => ({ meta: [{ title: "Переводы ЦР · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Переводы ЦР"
      description="Переводы цифровым рублём"
      action={
        <>
