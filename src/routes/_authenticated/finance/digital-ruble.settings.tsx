...
export const Route = createFileRoute("/_authenticated/finance/digital-ruble/settings")({
  head: () => ({ meta: [{ title: "Настройки ЦР · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Настройки ЦР"
      description="Безопасность и лимиты"
      action={
        <>
