...
export const Route = createFileRoute("/_authenticated/finance/autopayments")({
  head: () => ({ meta: [{ title: "Автоплатежи · ЦифроРубль" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PlatformPage
      title="Автоплатежи"
      description="Расписание регулярных списаний"
      action={
        <>
